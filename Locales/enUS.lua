...
-- Chat / general
L["ADDON_LOADED_HINT"]   = "loaded. Type /kicker to open the squad editor."
L["CMD_UNKNOWN"]         = "Unknown command '%s'. Try /kicker help."
L["CMD_HELP_HEADER"]     = "Commands:"
L["CMD_HELP_CONFIG"]     = "/kicker - open the squad editor"
L["CMD_HELP_PUSH"]       = "/kicker push - send squads to the group (leader/assist only)"
L["CMD_HELP_SHOW"]       = "/kicker show | hide - toggle the board"
L["CMD_HELP_LOCK"]       = "/kicker lock | unlock - stop or allow dragging the board"
L["CMD_HELP_RESET"]      = "/kicker reset - move the board back to the centre"
L["CMD_HELP_SCALE"]      = "/kicker scale <0.5-3.0> - resize the board"
L["BOARD_SCALE_SET"]     = "Board scale set to %.2f."
L["BOARD_SCALE_HELP"]    = "Usage: /kicker scale 0.5 to 3.0 (currently %.2f)."
L["CMD_HELP_ADVANCE"]    = "/kicker next - advance your squad's turn manually"
L["CMD_HELP_PROFILE"]    = "/kicker profile <name> - switch profile (creates it if new)"
L["CMD_HELP_PROFILE_DELETE"] = "/kicker profile delete <name> - delete a profile you are not using"
L["CMD_HELP_EXPORT"]     = "/kicker export | import - share squads as a string"
L["CMD_HELP_MACRO"]      = "/kicker macro - focus and marking macros for your marker"

-- Macros
L["MACRO_TITLE"]         = "Kicker - Macros"
...
L["CMD_HELP_STATUS"]     = "/kicker status - report what the addon can and cannot do here"
...
L["TRANSFER_ERR_FORMAT"] = "That does not look like a Kicker string."
...
L["BOARD_EMPTY"]         = "No squads yet - /kicker"
...
L["STATUS_BOARD_SHOWN"]  = "Board: on screen (/kicker reset if you cannot find it)"
L["STATUS_BOARD_EMPTY"]  = "Board: hidden because no squads are configured"
L["STATUS_BOARD_MANUAL"] = "Board: hidden by you (/kicker show)"
